 ...
 *       gravity edit-hazard, walk-through hazard, through-slow, fluid-neighbour) from the high 6 bits of
 *       the resident grid — all six allocated. ({@code HAS_FLUID_NEIGHBOR} is the flood-prediction
 *       funnel's tier-0 prefilter — DESIGN-fluid-flow-prediction.md §4/§5; see {@link NavFlags}.)
