...
/**
 * {@link CraftingOps} flavor for MC 1.20–1.20.1: {@code CraftingContainer} became an INTERFACE and
 * the synthetic grid is now a {@link TransientCraftingContainer} (1.20 primer). Everything else
 * matches the 1.19.4 flavor (see the 1.17 baseline for the contract + full override chain).
 * Overridden at 1.20.2.
 */
