 ...
 * always pass level + pos; this version ignores them. Compiled one flavor per MC version,
 * so the call stays monomorphic.
 *
 * <p>This is the MC 1.20.2+ era flavor. (The exact signature boundary will get its own
 * overlay era when the version walk-back pins it; this era currently targets 1.21.4.)
 */
