...
/**
 * {@link CraftingOps} flavor for MC 1.20.2–1.20.4: recipes are wrapped in {@link RecipeHolder}
 * ({@code Recipe#getId} removed — the id lives on the holder). Everything else matches the 1.20
 * flavor (see the 1.17 baseline for the contract + full override chain). Overridden at 1.20.5.
 */
public final class CraftingOps {
    ...
    private static KnownRecipe describe(RecipeHolder<CraftingRecipe> holder, RegistryAccess access) {
